...
def fitness(json_chromosome):
    ...
    if target == "all":
        ...
        sum_score = km_score+nw_score+pg_score+ts_score+wc_score
        return [sum_score/4,km_score,nw_score,pg_score,ts_score,wc_score]
...
best_solution = genetic_algorithm(pop_size=3000, max_gen=100, elitism_size = 450, mutation_rate=0.2)
